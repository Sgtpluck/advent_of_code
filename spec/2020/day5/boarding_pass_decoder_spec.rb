require './2020/day5/boarding_pass_decoder'

RSpec.describe BoardingPassDecoder do
  describe "run" do
    it "outputs a number" do
      expect(BoardingPassDecoder.run(path: "./spec/2020/day5/input.txt")).to be_an(Integer)
    end

    describe "with test input" do
      it "outputs 2" do
        expect(BoardingPassDecoder.run(path: "./spec/2020/day5/input.txt")).to eq(820)
      end
    end
...
RSpec.describe BoardingPass do
  let(:decoder) { BoardingPassDecoder.new(path: "./spec/2020/day5/input.txt") }
