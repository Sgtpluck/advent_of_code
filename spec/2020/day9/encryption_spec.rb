require './2020/day9/encryption'

RSpec.describe Encryption do
  describe "#run" do
    it "outputs a number" do
      expect(Encryption.run(path: "./spec/2020/day9/input.txt", preamble: 5)).to be_an(Integer)
    end

    describe "with test input" do
      it "outputs 5" do
      expect(Encryption.run(path: "./spec/2020/day9/input.txt", preamble: 5)).to eq(127)
      end
    end
  ...
  describe "#find_weakness" do
    describe "with test input" do
      let(:encryption) { Encryption.new(path: "./spec/2020/day9/input.txt", preamble: 5) }
      before do
        encryption.run
      end
