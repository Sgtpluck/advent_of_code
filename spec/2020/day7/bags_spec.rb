require './2020/day7/bags'

RSpec.describe Bags do
  describe "#bags_that_hold_my_bag" do
    it "outputs a number" do
      expect(Bags.bags_that_hold_my_bag(path: "./spec/2020/day7/input.txt")).to be_an(Integer)
    end

    describe "with test input" do
      it "outputs 4" do
        expect(Bags.bags_that_hold_my_bag(path: "./spec/2020/day7/input.txt")).to eq(4)
      end
    end
  ...
  describe "#needed_bags" do
    it "outputs a number" do
      expect(Bags.needed_bags(path: "./spec/2020/day7/input.txt")).to be_an(Integer)
    end

    describe "with test input" do
      it "outputs 32" do
        expect(Bags.needed_bags(path: "./spec/2020/day7/input.txt")).to eq(32)
      end
    end

    describe "with other test input" do
      it "outputs 4" do
        expect(Bags.needed_bags(path: "./spec/2020/day7/input1.txt")).to eq(126)
      end
    end
