require './2020/day4/passport_validation'

RSpec.describe PassportValidation do
  describe "run" do
    it "outputs a number" do
      expect(PassportValidation.run(path: "./spec/2020/day4/input.txt")).to be_an(Integer)
    end

    describe "with test input" do
      it "outputs 2" do
        expect(PassportValidation.run(path: "./spec/2020/day4/input.txt")).to eq(2)
      end
    end
    ...
    describe "with more validation rules" do
      describe "with test input" do
        it "outputs 4" do
          expect(PassportValidation.run(path: "./spec/2020/day4/input2.txt")).to eq(4)
        end
      end
