  ...
  describe "run" do
    ...
    describe "with wrong rules" do
      describe "with test input" do
        it "outputs 2" do
          expect(Password.run(path: "./spec/2020/day2/input.txt")).to eq(2)
        end
      end
    ...
    describe "with correct rules" do
      describe "with test input" do
        it "outputs 1" do
          expect(Password.run(path: "./spec/2020/day2/input.txt", rules: true)).to eq(1)
        end
      end
