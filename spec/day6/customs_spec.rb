require './day6/customs'

RSpec.describe Customs do
  describe "#uniq_yes_count" do
    it "outputs a number" do
      expect(Customs.uniq_yes_count(path: "./spec/day6/input.txt")).to be_an(Integer)
    end

    describe "with test input" do
      it "outputs 11" do
        expect(Customs.uniq_yes_count(path: "./spec/day6/input.txt")).to eq(11)
      end
    end
  ...
  describe "#intersection_yes_count" do
    describe "with test input" do
      it "outputs 6" do
        expect(Customs.intersection_yes_count(path: "./spec/day6/input.txt")).to eq(6)
      end
    end
